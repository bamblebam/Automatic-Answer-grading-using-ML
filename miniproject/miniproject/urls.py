...
urlpatterns = [
    ...
    path("new-question", quiz_views.newQuestionPage, name='new-question'),
    path("index/", quiz_views.homePage, name='index'),
    path('question/<int:id>', quiz_views.questionPage, name='question'),

]

# urls for allauth.urls
